:root {
  ...
  --color-background-cell-shaded-0vqgjs:#f8f8f8;
  ...
  --color-background-dropdown-item-hover-md83i5:#f4f4f4;
  --color-background-dropdown-item-selected-jhhqno:#f2f8fd;
  ...
  --color-background-item-selected-7tr5e4:#f2f8fd;
  ...
  --color-background-layout-toggle-active-robi8g:#354150;
  --color-background-layout-toggle-default-lmdlhy:#192534;
  --color-background-layout-toggle-hover-ho9150:#354150;
  ...
  --color-border-divider-default-et9j7s:#e9ebed;
  --color-border-divider-panel-bottom-16n9vt:#e9ebed;
  --color-border-divider-panel-side-qqne3x:#e9ebed;
  --color-border-dropdown-container-5boaph:#9ba7b6;
  --color-border-dropdown-group-zgquz8:#e9ebed;
  --color-border-dropdown-item-default-dofu99:#e9ebed;
  ...
  --color-border-tabs-divider-as2avh:#e9ebed;
  ...
  --color-text-body-secondary-so8znq:#414d5c;
  ...
  --color-text-dropdown-group-label-mej1lb:#414d5c;
  ...
  --color-text-expandable-section-default-lm3qgp:#000716;
  ...
  --color-text-group-label-zuh0h0:#414d5c;
  --color-text-heading-default-rtslvy:#000716;
  --color-text-heading-secondary-37b2tq:#414d5c;
  --color-text-home-header-default-uow452:#ffffff;
  --color-text-home-header-secondary-vojy0v:#d1d5db;
  --color-text-icon-subtle-c4qyia:#5f6b7a;
  --color-text-input-disabled-f8pjm5:#9ba7b6;
  --color-text-input-placeholder-qrb8p3:#5f6b7a;
  ...
  --border-divider-section-width-8a5uu9:2px;
  ...
  --border-panel-header-width-6icr2m:2px;
  ...
  --border-table-sticky-width-vc4wb9:2px;
  ...
  --space-layout-toggle-diameter-x54u6y:40px;
  --space-layout-toggle-padding-sgkxy2:20px;
  ...
  --space-scaled-2x-xxxl-eqb3m6:40px;
  ...
  --shadow-container-mwue46:0px 0px 1px 1px #e9ebed, 0px 1px 8px 2px rgba(0, 7, 22, 0.12);
  --shadow-container-stacked-4gw245:-1px 1px 1px 0px #e9ebed, 1px 1px 1px 0px #e9ebed, 0px 9px 8px -7px rgb(0 7 22 / 12%), 8px 0px 8px -7px rgb(0 7 22 / 12%), -8px 0px 8px -7px rgb(0 7 22 / 12%);
  --shadow-container-active-7yvi6w:0px 1px 1px 1px #e9ebed, 0px 6px 36px #0007161a;
  --shadow-dropdown-vswpbv:0px 4px 20px 1px rgba(0, 7, 22, 0.10);
  --shadow-dropup-7m0sn5:0px 4px 20px 1px rgba(0, 7, 22, 0.10);
  --shadow-flash-collapsed-s7gipk:0px 4px 4px rgba(0, 0, 0, 0.25);
  --shadow-flash-sticky-3mvsax:0px 6px 36px rgba(0, 7, 22, 0.10);
  --shadow-modal-espdsd:0px 4px 20px 1px rgba(0, 7, 22, 0.10);
  --shadow-panel-ezyqp4:0px 1px 1px 1px #e9ebed, 0px 6px 36px rgba(0, 7, 22, 0.10);
  --shadow-panel-toggle-0l64f2:0px 6px 12px 1px rgba(0, 7, 22, 0.12);
  --shadow-popover-ya6sww:0px 4px 20px 1px rgba(0, 7, 22, 0.10);
  ...
  --shadow-sticky-frfqle:0px 4px 20px 1px rgba(0, 7, 22, 0.10);
  --shadow-sticky-embedded-uvh5ry:0px 2px 0px 0px #e9ebed, 0px 16px 16px -12px rgba(0, 7, 22, 0.10);
  --shadow-sticky-column-first-avt88z:4px 0px 20px 1px rgba(0, 7, 22, 0.1);
  --shadow-sticky-column-last-9r9bro:-4px 0 20px 1px rgba(0, 28, 36, 0.1);
}
...
@media not print {
  .awsui-dark-mode:not(#\9) {
    ...
    --color-background-cell-shaded-0vqgjs:#232f3e;
    ...
    --color-background-dropdown-item-hover-md83i5:#354150;
    --color-background-dropdown-item-selected-jhhqno:#192534;
    --color-background-input-default-igdh5e:#0f1b2a;
    --color-background-input-disabled-ab59a3:#192534;
    --color-background-item-selected-7tr5e4:#192534;
    ...
    --color-border-divider-default-et9j7s:#414d5c;
    --color-border-divider-panel-bottom-16n9vt:rgba(0, 7, 22, 1);
    --color-border-divider-panel-side-qqne3x:#414d5c;
    --color-border-dropdown-container-5boaph:#5f6b7a;
    --color-border-dropdown-group-zgquz8:#414d5c;
    --color-border-dropdown-item-default-dofu99:#414d5c;
    ...
    --color-border-tabs-divider-as2avh:#414d5c;
    ...
    --color-text-body-default-2sxhhn:#d1d5db;
    --color-text-body-secondary-so8znq:#d1d5db;
    ...
    --color-text-dropdown-group-label-mej1lb:#8d99a8;
    ...
    --color-text-expandable-section-default-lm3qgp:#fbfbfb;
    ...
    --color-text-group-label-zuh0h0:#8d99a8;
    --color-text-heading-default-rtslvy:#e9ebed;
    --color-text-heading-secondary-37b2tq:#8d99a8;
    --color-text-icon-subtle-c4qyia:#9ba7b6;
    --color-text-input-disabled-f8pjm5:#5f6b7a;
    --color-text-input-placeholder-qrb8p3:#7d8998;
    ...
    --shadow-container-mwue46:0px 1px 8px 2px rgba(0, 7, 22, 0.6);
    --shadow-container-stacked-4gw245:0px 9px 8px -7px rgb(0 7 22 / 60%), 8px 0px 8px -7px rgb(0 7 22 / 60%), -8px 0px 8px -7px rgb(0 7 22 / 60%);
    --shadow-container-active-7yvi6w:0px 1px 1px 1px #192534, 0px 6px 36px #000716;
    --shadow-dropdown-vswpbv:0px 4px 20px 1px rgba(0, 7, 22, 1);
    --shadow-dropup-7m0sn5:0px 4px 20px 1px rgba(0, 7, 22, 1);
    --shadow-flash-sticky-3mvsax:0px 6px 36px rgba(0, 7, 22, 1);
    --shadow-modal-espdsd:0px 4px 20px 1px rgba(0, 7, 22, 1);
    --shadow-panel-ezyqp4:0px 1px 1px 1px #192534, 0px 6px 36px rgba(0, 7, 22, 1);
    --shadow-panel-toggle-0l64f2:0px 6px 12px 1px rgba(0, 7, 22, 1);
    --shadow-popover-ya6sww:0px 4px 20px 1px rgba(0, 7, 22, 1);
    ...
    --shadow-sticky-frfqle:0px 4px 20px 1px rgba(0, 7, 22, 1);
    --shadow-sticky-embedded-uvh5ry:0px 2px 0px 0px #414d5c, 0px 16px 16px -12px rgba(0, 7, 22, 1);
    --shadow-sticky-column-first-avt88z:0px 4px 20px 1px rgba(0, 7, 22, 1);
    --shadow-sticky-column-last-9r9bro:0px 4px 20px 1px rgba(0, 7, 22, 1);
  }
}
.awsui-compact-mode:not(#\9) {
  ...
  --space-layout-toggle-padding-sgkxy2:16px;
  ...
  --space-scaled-2x-xxxl-eqb3m6:24px;
...
.awsui-context-flashbar:not(#\9) {
  ...
  --color-border-divider-default-et9j7s:#fbfbfb;
  --color-border-divider-panel-bottom-16n9vt:#fbfbfb;
  --color-border-divider-panel-side-qqne3x:#fbfbfb;
  --color-border-dropdown-group-zgquz8:#fbfbfb;
  --color-border-dropdown-item-default-dofu99:#fbfbfb;
  --color-border-item-focused-b2ntyl:#fbfbfb;
  --color-text-body-default-2sxhhn:#fbfbfb;
...
.awsui-context-flashbar-warning:not(#\9) {
  ...
  --color-border-divider-default-et9j7s:#000716;
  --color-border-divider-panel-bottom-16n9vt:#000716;
  --color-border-divider-panel-side-qqne3x:#000716;
  --color-border-dropdown-group-zgquz8:#000716;
  --color-border-dropdown-item-default-dofu99:#000716;
...
.awsui-context-alert:not(#\9) {
  ...
  --color-border-button-normal-hover-qs1x3s:#000716;
  --color-border-divider-default-et9j7s:#414d5c;
  --color-border-divider-panel-bottom-16n9vt:#414d5c;
  --color-border-divider-panel-side-qqne3x:#414d5c;
  --color-border-dropdown-group-zgquz8:#414d5c;
  --color-border-dropdown-item-default-dofu99:#414d5c;
  --color-text-button-normal-active-4it2mv:#000716;
  ...
  --color-text-button-normal-hover-04pe0y:#000716;
  --color-text-link-button-normal-active-pv8vqs:#000716;
  --color-text-expandable-section-default-lm3qgp:#414d5c;
  --color-text-expandable-section-hover-2d1zpj:#000716;
  --font-expandable-heading-size-smdiul:14px;
  --border-code-editor-status-divider-width-6zj7o8:1px;
  --border-divider-section-width-8a5uu9:1px;
}
...
.awsui-context-content-header .awsui-context-alert:not(#\9) {
  ...
  --color-border-control-disabled-bv2kkn:#354150;
  --color-border-divider-active-k4haaf:#fbfbfb;
  --color-border-divider-default-et9j7s:#d1d5db;
  --color-border-divider-panel-bottom-16n9vt:rgba(0, 7, 22, 1);
  --color-border-divider-panel-side-qqne3x:#d1d5db;
  --color-border-dropdown-container-5boaph:#5f6b7a;
  --color-border-dropdown-group-zgquz8:#d1d5db;
  --color-border-dropdown-item-default-dofu99:#d1d5db;
  --color-border-dropdown-item-hover-461g78:#5f6b7a;
  --color-border-editable-cell-hover-nqrv6y:#5f6b7a;
  --color-border-input-default-1zl7hq:#5f6b7a;
  --color-border-input-disabled-rx2aau:#192534;
  ...
  --color-text-dropdown-item-secondary-hover-zfmqjr:#d1d5db;
  --color-text-empty-2wfcyr:#d1d5db;
  --color-text-expandable-section-default-lm3qgp:#d1d5db;
  --color-text-expandable-section-hover-2d1zpj:#ffffff;
  --color-text-expandable-section-navigation-icon-default-htcovl:#d1d5db;
  --color-text-form-default-vh42kd:#d1d5db;
  --color-text-form-label-ktbzsd:#d1d5db;
