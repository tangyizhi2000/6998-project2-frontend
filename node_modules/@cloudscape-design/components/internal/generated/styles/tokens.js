...
export var colorBackgroundCellShaded = "var(--color-background-cell-shaded-0vqgjs, #f8f8f8)";
...
export var colorBackgroundDropdownItemHover = "var(--color-background-dropdown-item-hover-md83i5, #f4f4f4)";
...
export var colorBackgroundItemSelected = "var(--color-background-item-selected-7tr5e4, #f2f8fd)";
export var colorBackgroundLayoutMain = "var(--color-background-layout-main-nx09lr, #ffffff)";
export var colorBackgroundLayoutToggleActive = "var(--color-background-layout-toggle-active-robi8g, #354150)";
export var colorBackgroundLayoutToggleDefault = "var(--color-background-layout-toggle-default-lmdlhy, #192534)";
export var colorBackgroundLayoutToggleHover = "var(--color-background-layout-toggle-hover-ho9150, #354150)";
...
export var colorTextBodyDefault = "var(--color-text-body-default-2sxhhn, #000716)";
export var colorTextBodySecondary = "var(--color-text-body-secondary-so8znq, #414d5c)";
...
export var colorTextGroupLabel = "var(--color-text-group-label-zuh0h0, #414d5c)";
export var colorTextHeadingDefault = "var(--color-text-heading-default-rtslvy, #000716)";
export var colorTextHeadingSecondary = "var(--color-text-heading-secondary-37b2tq, #414d5c)";
export var colorTextHomeHeaderDefault = "var(--color-text-home-header-default-uow452, #ffffff)";
export var colorTextHomeHeaderSecondary = "var(--color-text-home-header-secondary-vojy0v, #d1d5db)";
export var colorTextInputDisabled = "var(--color-text-input-disabled-f8pjm5, #9ba7b6)";
export var colorTextInputPlaceholder = "var(--color-text-input-placeholder-qrb8p3, #5f6b7a)";
...
export var shadowContainerActive = "var(--shadow-container-active-7yvi6w, 0px 1px 1px 1px #e9ebed, 0px 6px 36px #0007161a)";