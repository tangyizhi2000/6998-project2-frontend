...
export function Resizer({ onWidthUpdate, onWidthUpdateCommit, ariaLabelledby, minWidth = DEFAULT_COLUMN_WIDTH, tabIndex, showFocusRing, focusId, }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("span", Object.assign({ ref: resizerRef, className: clsx(styles.resizer, isDragging && styles['resizer-active'], (resizerHasFocus || showFocusRing) && styles['has-focus']), onMouseDown: event => {
                if (event.button !== 0) {
                    return;
                }
                event.preventDefault();
            ...
            } }, resizerAriaProps, { tabIndex: tabIndex, "data-focus-id": focusId }))));
}
